...
interface ChainTokenTransfersProps {
  data: {
    transfers: {
      items: Array<{
...
export function ChainTokenTransfers({ data, chain }: ChainTokenTransfersProps) {
      ...
      <div className="p-6 rounded-4xl">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <ExternalLink
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          window.open(getExplorerUrl('address', contract.address), '_blank');
                        }}
                      />
                    </div>
                  </div>
        ...
        <div className="grid gap-4">
          {activeTransfers.map((transfer) => {
            ...
            const value = Number(transfer.value) / Math.pow(10, transfer.contract.decimals || 18);
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-1 text-sm">
                      ...
                      <ExternalLink
                        ...
                        onClick={(e) => {
                          e.stopPropagation();
                          window.open(getExplorerUrl('address', counterparty), '_blank');
                        }}
                      />
                    </div>
                    {isExpanded ?
                ...
                >
                  <div className="p-4 bg-white space-y-3">
                    ...
                    <button
                      ...
                      onClick={(e) => {
                        e.stopPropagation();
                        window.open(getExplorerUrl('tx', transfer.transactionHash), '_blank');
                      }}
                    >
